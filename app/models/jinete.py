...
class Jinete(Base):
    ...
    localidad: Mapped[str | None] = mapped_column(String(100), nullable=True, index=True)

    categoria_habitual: Mapped[str | None] = mapped_column(String(100), nullable=True)
